    ...
    return (
        <div className='place-order'>
            <div className="place-order-left">
                <p className='title'>Informações do pedido</p>
            ...
            <div className="place-order-right">
                <div className="cart-total">
                    ...
                    <div>
                        ...
                        <hr />
                        <div className="cart-total-details"><p>Taxa</p><p>${getTotalCartAmount() === 0 ? 0 : 5}</p></div>
                        <hr />
                        <div className="cart-total-details"><b>Total</b><b>${getTotalCartAmount() === 0 ? 0 : getTotalCartAmount() + 5}</b></div>
                    </div>
                </div>
                <div className="payment-options">
                    <h2>Selecione a formad e pagamento:</h2>
                    <div className="payment-option">
                        <img src={assets.selector_icon} alt="" />
                        <p>COD (Pagamento na entrega)</p>
                    </div>
                    <button onClick={() => placeOrder(data)}>Peça</button>
                </div>
